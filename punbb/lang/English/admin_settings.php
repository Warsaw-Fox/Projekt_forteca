...
// Setup section
'Setup personal'				=>	'Personalize your installation',
...
'Setup local'					=>	'Configure your location',
...
'URL scheme info'				=>	'<strong>WARNING!</strong> The server that hosts the forums must be configured with mod_rewrite support and must allow the use of <em>.htaccess</em> files. For servers other than Apache, please refer to your servers documentation.',
...
// Features section
'Features general'				=>	'General features which are optional',
...
'Show version label'			=>	'Show version number in the footer.',
'Show moderators'				=>	'Show moderators',
'Show moderators label'			=>	'Show moderators list on the index page.',
...
'Features update info'			=>	'Allow to periodically check if there are any important updates to your software. The updates may be new releases or hotfix extensions. When updates are available an alert for administrator will appear.',
...
'Allow form e-mail label'		=>	'Hide email address but allow email via the forum.',
'Disallow form e-mail label'	=>	'Hide email address and disallow email via the forum.',
...
// Email section
'E-mail addresses'				=>	'Forum email addresses and mailing list',
'E-mail addresses legend'		=>	'Email addresses',
'Admin e-mail'					=>	'Administrator\'s email',
'Webmaster e-mail label'		=>	'Webmaster email',
'Webmaster e-mail help'			=>	'The "from" address of emails sent by the forum',
